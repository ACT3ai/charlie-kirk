...
## Purpose
To require all United States Intelligence Community agencies to release all information in their possession that could identify the perpetrator(s) of, or provide substantive insight into, the death of [Charlie Kirk](/People/charlie-kirk), including but not limited to the intelligence-related items enumerated in Schedule A of this Act, while protecting only currently active intelligence sources. Charlie Kirk was assassinated on September 10, 2025 at Utah Valley University, and this Act exists because the [record of how he was killed](/Cause_of_Death/overview) remains contested and substantially withheld from the public.
...
* An attorney warns [four mismatched Schedule A counts](/laws/other/analysis/Improve) could gut criminal enforcement under the rule of lenity.
* Surveillance stills reportedly show [a pronounced limp that vanishes at 12:22](/Tyler_Robinson/Tyler_9_10_2025).
* Independent audio-visual analyses [place the shot far closer than the rooftop](/Tyler_Robinson/Shooting/overview).
