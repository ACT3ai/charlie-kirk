...
![Law 1: FBI & Law Enforcement Release Files](./4_laws_svg/law_1.svg)
...
<a href="/laws/1_DoJ_FBI/Law_1_DoJ_FBI" style={{display:'inline-block', marginTop:'0.5rem', marginBottom:'0.5rem', padding:'0.6rem 1.5rem', background:'#1a73e8', color:'#fff', borderRadius:'4px', textDecoration:'none', fontWeight:'bold', fontSize:'1rem'}}>Read Law Number One →</a>
...
<a href="/laws/2_US_Intel/Law_2_US_Intel" style={{display:'inline-block', marginTop:'0.5rem', marginBottom:'0.5rem', padding:'0.6rem 1.5rem', background:'#1a73e8', color:'#fff', borderRadius:'4px', textDecoration:'none', fontWeight:'bold', fontSize:'1rem'}}>Read Law Number Two →</a>
...
<a href="/laws/3_Require_to_Investigate/Law_3_Require_to_Investigate" style={{display:'inline-block', marginTop:'0.5rem', marginBottom:'0.5rem', padding:'0.6rem 1.5rem', background:'#1a73e8', color:'#fff', borderRadius:'4px', textDecoration:'none', fontWeight:'bold', fontSize:'1rem'}}>Read Law Number Three →</a>
...
<a href="/laws/4_Trusted_Investigations/Law_4_Trusted_Investigations" style={{display:'inline-block', marginTop:'0.5rem', marginBottom:'0.5rem', padding:'0.6rem 1.5rem', background:'#1a73e8', color:'#fff', borderRadius:'4px', textDecoration:'none', fontWeight:'bold', fontSize:'1rem'}}>Read Law Number Four →</a>
...
* [Law 1: FBI & DOJ Disclosure](/laws/1_DoJ_FBI/Law_1_DoJ_FBI)
* [Law 2: Intelligence Disclosure](/laws/2_US_Intel/Law_2_US_Intel)
* [Law 3: Mandate the Investigation](/laws/3_Require_to_Investigate/Law_3_Require_to_Investigate)
* [Law 4: Trusted Investigators](/laws/4_Trusted_Investigations/Law_4_Trusted_Investigations)
