...
<img src={require('./4_laws_svg/law_1.svg').default} alt="Law 1: FBI & Law Enforcement Release Files" style={{float:'right', width:'70%', maxWidth:'70%', height:'auto', marginLeft:'1.5rem', marginBottom:'1rem'}} />
