...
(a) Each investigation team shall specifically pursue the leads and information identified in Schedule A (227 Critical Disclosure Items), including but not limited to:
   ...
   5. **Financial Connections:** Wire transfers to Tyler Robinson and [Lance Twiggs](/People/lance-twiggs), payments to distraction people, foreign financial activity in Utah
   ...
   7. **Pre-Planning and Foreknowledge:** [Fort Huachuca](/US_Intelligence/Fort_Huachuca/overview) meetings (including aircraft [N582MM](/Planes/N582MM)'s documented October 4–5, 2025 presence at Fort Huachuca), One Rodney Square meetings, TPUSA security planning anomalies, Charlie Kirk's death threats, the declined business deal, Hampton meeting
   ...
   11. **Security Detail Foreign Connections:** [Brian Harpole](/People/brian-harpole)'s foreign security background on Kirk's detail
   12. **Medical & Hospital Records:** Hospital routing decisions, FBI blocking a surgeon, glass/plastic fragments in transport
   13. **TPUSA Financial Irregularities or Possible Fraud:** Payments to entities alleged to be shell companies (Resource One, Clocktower LLC), post-assassination board actions and [Erika Kirk](/People/erika-kirk)'s CEO appointment, examined solely to determine whether any irregularities or possible fraud may exist
