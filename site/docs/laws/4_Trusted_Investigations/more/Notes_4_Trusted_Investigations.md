...
* [Law 4](/laws/Trusted_Investigations/Law_4_Trusted_Investigations) goes past the special-counsel model by seating private citizens inside.
* [The requirements page](/laws/Trusted_Investigations/more/Human_Requirements) is the plain-English version these precedents are tested against.
* [Attorney review](/laws/other/analysis/Improve) still calls the Appointments Clause this law's likeliest fatal challenge.
* [Law 3's notes](/laws/Require_to_Investigate/more/Notes_3_Require_to_Investigate) warn that the Warren Commission met its mandate anyway.
