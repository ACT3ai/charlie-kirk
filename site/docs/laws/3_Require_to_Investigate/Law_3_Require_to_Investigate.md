...
(b) The investigation shall:
   ...
   - Specifically investigate all Schedule A items within the FBI's areas of responsibility, including but not limited to Items #58-#67 (FBI investigation files), #68-#74 (cell phone and digital data), #106-#113 (chain of custody and physical evidence), #119-#124 (surveillance and video evidence), #142-#149 (ballistics and forensics), and #193-#195 (FBI RAV4 and weapon re-search)
...
(b) The investigation shall:
   ...
   - Specifically investigate all intelligence-related leads in Schedule A, including but not limited to Items #1-#57 (intelligence service discovery), #82-#92 (aircraft and surveillance), and #156-#177 (foreign intelligence operations)
   - Produce public disclosure reports every 6 months documenting all findings, all output documents discovered, and as much information as can be provided
   - Operate for a minimum of 2 years from the date of team formation
...
(b) The investigation shall:
   ...
   - Specifically investigate all SIGINT and electronic warfare leads in Schedule A, including but not limited to Items #8-#12 (electronic warfare and jamming), #68-#74 (cell phone and digital data), and any intercepted communications relevant to the investigation
   - Produce public disclosure reports every 6 months documenting all findings, all output documents discovered, and as much information as can be provided
   - Operate for a minimum of 2 years from the date of team formation
...
(b) The intelligence assessment shall:
   ...
   - Specifically investigate all intelligence-related leads in Schedule A (Items #1-#57, #63-#67, #82-#92, #156-#177)
   - Produce public disclosure reports every 6 months documenting all findings, all output documents discovered, and as much information as can be provided
   - Operate for a minimum of 2 years from the date of team formation
...
**Evidence Chain of Custody and Point of Origin:**
   ...
   7. Point of origin of the fatal injury, including any location other than the rooftop

**Financial Connections:**
   1. Wire transfers to Tyler Robinson (alleged $50K through DSA-linked accounts)
   2. Financial connections between distraction persons and any intelligence service or handler
   3. The approximately $8 million in DOD contracts awarded to Bilt Inc. in June 2025 by the U.S. Air Force, the identity of all persons behind the company, all government officials who authorized the payments, all invoices and deliverables, and all financial flows into and out of Bilt Inc. from six months before September 2025 through the date of enactment
...
**Additional Mandatory Investigation Items:**
   ...
   5. All records related to Tyler Robinson's family statements and his claim of knowledge of other perpetrators (Items #177-#180)
   6. All records of witness intimidation including coercive counseling sessions and witness suppression (Items #180-#182)
   7. All records related to Brian Harpole and the contracted private security detail (Item #183)
   8. All records related to hospital routing decisions and FBI blocking a surgeon (Items #183-#186)
   9. All TPUSA financial records, including subsidiary and affiliated entity payments and post-assassination board actions, sufficient to permit investigators to determine whether any financial irregularities or possible fraud occurred (Items #186-#188)
   10. All records from Mosaic Pro Events, the Rode Wireless PRO microphone audio, and Mikey McCoy's mic-up video (Items #188-#191)
   11. All records identifying the object seen in Butch Hibbs's front pocket at UVU (records only; no involvement is claimed), and, as a separate matter, the Heber City to Nashville flight of August 25, 2025 (Items #191-#193)
   12. All records of the FBI RAV4 near Robinson and FBI direction of the re-search that located the weapon (Items #193-#195)
   13. All records of the Fort Huachuca meeting of September 1-11, 2025 (Item #196)
   14. All records of live stream interruptions at UVU (Item #197)
   15. All of Kirk's pre-death warnings, records on his parents' legal representation decisions, and his girlfriend (Items #197-#200)
   16. Full forensic analysis of bullet casing engravings and evidence authenticity assessment (Item #201)
   17. All records related to UVU crime scene paving (Item #202)
   18. All records of the AES factory explosion investigation and its connection to DoD contract N0016425PJ538 (Item #203)
...
- [Pocket Object Records](#pocket-object-records-192) (#192)
- [Heber City to Nashville Flight](#heber-city-to-nashville-flight-193) (#193)
...
* #33: Point of Origin Analysis: The investigation teams shall investigate and produce all records, files, and investigation data relating to where the fatal injury to Charlie Kirk originated, including whether it originated from any location other than the rooftop. All rooftop access logs, surveillance footage of rooftops, and law enforcement sweeps of rooftops before, during, and after the shooting. All records establishing whether the person observed on the roof was running at the moment the shot was fired, and all video footage, witness statements, or analysis addressing the rooftop suspect's movement and posture at the time of the shot. The total number of shots fired and the direction each originated from. All evidence supporting or refuting a coordinated cell operation with multiple actors — including a shooter, a spotter for logistics, and an exfiltration handler — potentially under quasi-governmental or private military contractor auspices, and the FBI's admission of possible multiple accomplices. The investigation shall encompass all records relating to any analysis of alternative trajectories or points of origin.
...
* #145: Rifle Import Records: The investigation teams shall investigate and produce all ATF and CBP import documentation if the weapon came from abroad. The investigation shall encompass all records relating to any foreign origin, international transfer, or importation of the rifle or its components.
...
* #172: Time of Death Determination: The investigation teams shall investigate: The precise time-of-death analysis from the medical examiner. The investigation shall encompass all records relating to any analysis establishing the exact timeline of the fatal event and Kirk's death.
...
* #183: Brian Harpole — Contracted Security Detail Records: The investigation teams shall investigate and produce all records, contracts, and communications related to Brian Harpole, a former police officer who headed the contracted private security detail for Charlie Kirk on September 10, 2025, and whose firm was reportedly engaged shortly before the event. The investigation shall encompass the detail's contract, staffing roster, and protection plan for the event, who placed the firm on Kirk's detail, his communications in the 30 days before and after the assassination, and any coordination between the detail and any government agency or third party regarding the event's security.
...
(c) **"Good-faith investigation"** means an investigation that:
   ...
   - Specifically investigates all leads and theories identified in Schedule A (227 Critical Disclosure Items), including but not limited to: the exploding microphone theory, foreign intelligence service involvement, evidence of cover-up, evidence planting, and electronic warfare
   - Does not treat any government agency, intelligence service, or foreign government as exempt from suspicion

(d) **"Schedule A"** means the document titled "Charlie Kirk 227 Critical Disclosure Items" as maintained at https://github.com/BryanStarbuck/Charlie_Kirk_175_Critical_To_Expose, incorporated by reference and attached as an appendix to this Act.
...
(c) Failure to investigate foreign-government-related leads (Items #2, #26, #56, #63-#67, #88-#92, #173-#177) is a per se bad-faith indicator triggering mandatory oversight board intervention.
...
Peer laws: [<span className="off-lead">Law 1 - DoJ/FBI Disclosure</span>](/laws/DoJ_FBI/Law_1_DoJ_FBI) | Law 2 - US Intel Disclosure | Law 4 - Trusted Investigators
...
* [<span className="off-lead">Law 1: Charlie Kirk Investigation - DoJ/FBI Forced Disclosure…</span>](/laws/DoJ_FBI/Law_1_DoJ_FBI)
