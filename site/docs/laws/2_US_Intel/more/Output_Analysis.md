...
* [Eight categories of covered information](/laws/US_Intel/Law_2_US_Intel) and a thirty-day catch-all, per [the requirements](/laws/US_Intel/more/Human_Requirements).
...
* [Proof of intelligence involvement](/Proof_Intel_Services/overview) is what these categories would either establish or dissolve.
...
<div className="ck-4sq-card ck-4sq-stack">
  <div className="ck-4sq-body">
    <p className="ck-4sq-title"><a href="/laws/other/analysis/Fixed/Laws_Not_Complying">Laws Not Complying with Charter &mdash; FIXED / RESOLVED ITEMS</a></p>
