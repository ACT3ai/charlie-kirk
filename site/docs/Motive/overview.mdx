...
description: "This page summarizes the main motive theories and questions discussed in connection with Charlie Kirk’s killing. It does not endorse any particular…"
keywords:
  - Charlie Kirk
...
<div style={{float: 'right', width: '45%', maxWidth: '480px', margin: '0.3rem 0 1rem 1.5rem'}}>
  <video controls playsInline preload="metadata" style={{width: '100%', height: 'auto', aspectRatio: '16 / 9', display: 'block', borderRadius: '8px'}}>
  ...
  <p style={{fontSize: '0.85rem', color: '#666', marginTop: '0.5rem', textAlign: 'center'}}>
    <em>"Chain of Evil" — tracing the network of donors, influence operations, and foreign intelligence interests behind the broader motive theories. Hosted on IPFS at CID <code>QmS64aK5A7BfPP3C645FLBSQRdXcMCyCtCxddAQixoQ22K</code> and served via public gateways.</em>
  </p>
</div>
...
* Donor and lobbying communications pressuring Kirk and the foreign-nexus leads the FBI halted and intel-service surveillance of Kirk's policy shift are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
...
* [Geopolitical and Intelligence‑Service Motive Theories](/Motive/Geopolitical_Intel_Service_Theories)
* [Institutional, Media, and Organizational Motive Dynamics](/Motive/Institutional_Media_Organizational_Dynamics)

</div>
<div>

* [Tyler Robinson’s Alleged Personal and Ideological Motives](/Motive/Tyler_Robinson_Alleged_Motive)
* [Real Killer](/Killer/overview)
