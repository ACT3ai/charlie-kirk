...
- **Use of state‑level tradecraft (claims):**  
  - Theories that emphasize **aircraft (such as [Egyptian Air Force jets](/Planes/Egyptian-Armada))**, **ISR platforms like [N1098L](/Planes/N1098L/overview)**, or sophisticated **drone and comms capabilities** sometimes suggest that only state‑backed or contractor‑grade actors could orchestrate such operations.  
...
* NSA XKeyscore and SIGINT queries on the case actors and flight manifests for the Egyptian jets and N1098L and NCTC records on the alleged rogue-faction suspicions are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
