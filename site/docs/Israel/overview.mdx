...
* subscriber IDs of the ~12 Israeli-registered phones at UVU and NSA XKeyscore queries behind the Israeli IP search spikes and flight manifests for the [SU-BTT](/Planes/SU-BTT) and Israeli-linked planes are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
