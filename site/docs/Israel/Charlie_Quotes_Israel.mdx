...
- X posts by users such as `@hodgetwins`, `@FactsVsZee`, and `@BalochRamzan2`, and segments discussed by commentators like **Harrison Smith** and **Candace Owens**, are commonly cited as carriers of these quotes.  
...
- Additional commentary threads share video segments where Charlie questions delays or aspects of the Gaza situation, sometimes amplified by commentators like **Ian Carroll** (`@IanCarrollShow` on X).
