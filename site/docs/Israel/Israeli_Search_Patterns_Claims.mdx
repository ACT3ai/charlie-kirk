...
- **Egyptian aircraft and related terms (claims):**  
  - Similar analyses suggest Israeli‑origin search spikes around **Egyptian tail numbers** (such as [SU‑BTT](/Planes/SU-BTT)), certain Utah political figures, and contractors mentioned in flight or construction narratives.
