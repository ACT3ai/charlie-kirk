...
- **@bgilberg79** (July 12, 2026): frame-by-frame analysis allegedly shows shirt motion from **something internal** before the wound appears — a claim that overlaps the [exploding-mic](./explosive-mic-killed-charlie) page rather than pure external ballistics.
