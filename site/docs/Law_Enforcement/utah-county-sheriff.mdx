...
**Governor Spencer Cox** held a press conference with **Sheriff Mike Smith** present while the surrender was still being coordinated — timing questions appear in [Utah DPS & Beau Mason](./utah-dps-beau-mason) and [key_individuals/Officials](/key_individuals/Officials_And_Law_Enforcement). The research file's attendance list for that state press event names **Cox, Lt. Gov. Henderson, FBI Director Kash Patel, Deputy FBI Director Dan Bongino, Sheriff Mike Smith, and FBI SAIC Robert Bohls.**
