...
description: "This page provides a high‑level view of how intelligence agencies and intelligence‑related themes — both U.S. and foreign — appear in discussions about the…"
keywords:
  - Charlie Kirk
...
* NSA XKeyscore and SIGINT queries on the phones and addresses involved and subscriber identities of the foreign cell phones at UVU and CBP entry-exit manifests for foreign nationals are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
