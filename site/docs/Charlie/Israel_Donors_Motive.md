...
- **Late 2024–mid‑2025 groundwork (claims):**  
  Entries reference Google Trends spikes from foreign IPs (including Israeli addresses) searching for Tyler Robinson, Utah locations, hospital personnel, and legal actors months before the shooting. These are framed as potential indicators of advance interest or planning, but the underlying data and attribution are not independently reproduced here.
