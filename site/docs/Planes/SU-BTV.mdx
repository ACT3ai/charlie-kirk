...
Be honest about the sourcing: **standalone reporting on SU-BTV specifically is thin.** It is rarely discussed on its own; its significance is almost entirely as a member of the fleet pattern. The bulk of the analysis — the timeline, the TPUSA-overlap claims, the maintenance counterpoints — lives on the hub page, **[Israel/Egyptian Plane Armada](/Planes/Egyptian-Armada)**. This page collects only what public sources say about SU-BTV by name and frames every claim as an open, unverified allegation.
...
* **Nickname in coverage:** None. Candace Owens color-coded SU-BTT ("blue plane") and SU-BND ("yellow plane"); SU-BTV carries no color label and is listed only in flight-overlap discussions.
...
### Broader 2022–2025 window

Beyond the 2025 legs above, the same OSINT threads claim SU-BTV shows up as **multiple instances across 2022–2025** that allegedly **overlap with Charlie Kirk / TPUSA events**, with the Provo-area presence concentrated in the months before September 2025. This longer window is presented as part of the fleet-pattern argument rather than as individually documented SU-BTV flights — it is an unverified OSINT framing, and the multi-year overlap claim is **disputed**. For the full timeline, counterpoints, and the contested overlap-count analysis, see the [Israel/Egyptian Plane Armada](/Planes/Egyptian-Armada) hub.
...
Other mundane explanations also weigh against the sinister reading: a skeptic's audit of Owens's overlap counts reportedly found several of the cited dates wrong, transponder/track artifacts can mimic "stealth" behavior, and the companion "yellow plane" SU-BND reportedly sat in Provo for months — more consistent with a long maintenance or storage stay than a surgical operation. These counterpoints are covered in full on the [Israel/Egyptian Plane Armada](/Planes/Egyptian-Armada) hub.
