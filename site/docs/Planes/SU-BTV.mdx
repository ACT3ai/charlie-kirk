...
* **Foreign orchestration** — the @ProjectConstitu thread floated "[Mossad](/intelligence/Mossad) proxies via Egypt" and alleged "no-scan DoD badges" dropping "experts" for drone/laser operations. These are unverified assertions made about the fleet as a whole, with no specific evidence tied to SU-BTV.
