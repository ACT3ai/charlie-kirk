...
description: "ISR — Intelligence, Surveillance, and Reconnaissance — is the umbrella term for military and contracted aviation missions that collect intelligence in real…"
keywords:
  - Charlie Kirk
...
This ISR program context encompasses N1098L (HADES) and similar military ISR assets. Citizen investigators have focused on these aircraft's surveillance capabilities, their low-level operations, and the possibility of real-time monitoring during the assassination. Whether the September 10 flight profile reflects **routine operations** or a **targeted use** of ISR assets has been debated extensively online, and remains an open question rather than a settled conclusion.
...
* N1098L's HADES ISR sensor records over UVU and the classified contractor crew and mission tasking for that flight and who has accessed the airborne kill-zone footage are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
...
This page describes an ISR *program* rather than one tail number. To research the aircraft tied to it, track the LASAI Aviation Global 6500s on both major flight-tracking sites. FlightRadar24 honors the FAA's [LADD](https://www.faa.gov/pilots/ladd) block list (some flights can be hidden); ADS-B Exchange is volunteer-fed and unfiltered (it often shows blocked aircraft and tracks the filtered sites leave out).

* N1098L — [FlightRadar24](https://www.flightradar24.com/data/aircraft/n1098l) · [ADS-B Exchange](https://globe.adsbexchange.com/?reg=N1098L)
