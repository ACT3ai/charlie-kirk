...
**58 files across 5 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 8 | 8 | 2025-09-04 → 2025-09-16 |
| `adsbexchange-samples` | samples.adsbexchange.com | 17 | 17 | 2023-11-01 → 2026-05-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 29 | 29 | 2025-09-04 → 2026-06-05 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightaware` | web.archive.org copy of flightaware.com/live/flight/TAIL | 3 | 3 | 2023-03-26 → 2025-09-20 |
