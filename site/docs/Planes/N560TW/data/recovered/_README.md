...
**62 files across 5 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 9 | 9 | 2025-09-01 → 2025-10-09 |
| `adsbexchange-samples` | samples.adsbexchange.com | 23 | 23 | 2022-01-01 → 2026-08-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 27 | 27 | 2025-09-01 → 2026-06-05 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightaware` | web.archive.org copy of flightaware.com/live/flight/TAIL | 2 | 2 | 2016-11-29 → 2026-04-15 |
