...
* **Airborne command/relay station ("Task Force Charlie").** Investigator **@raumgeist** has theorized that N1098L served as an airborne command center or relay station passing data to **Fort Huachuca** as part of what that poster calls "Task Force Charlie," allegedly providing software coordination for the operation, with a possible ground station on campus or carried in a backpack. This is @raumgeist's stated theory and is unverified; no tasking record supports it.
