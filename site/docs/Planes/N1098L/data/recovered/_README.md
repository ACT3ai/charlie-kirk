...
**86 files across 5 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 17 | 17 | 2025-09-02 → 2025-10-11 |
| `adsbexchange-samples` | samples.adsbexchange.com | 19 | 19 | 2023-11-01 → 2026-08-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 46 | 46 | 2025-09-02 → 2026-06-03 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightaware` | web.archive.org copy of flightaware.com/live/flight/TAIL | 3 | 3 | 2023-05-07 → 2025-09-23 |
