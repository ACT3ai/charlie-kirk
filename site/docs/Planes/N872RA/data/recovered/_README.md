...
**85 files across 4 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 12 | 12 | 2025-09-01 → 2025-10-10 |
| `adsbexchange-samples` | samples.adsbexchange.com | 24 | 24 | 2022-04-01 → 2026-08-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 48 | 48 | 2025-09-01 → 2026-06-05 |
