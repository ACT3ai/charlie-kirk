...
**74 files across 5 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 19 | 19 | 2025-09-01 → 2025-10-11 |
| `adsbexchange-samples` | samples.adsbexchange.com | 23 | 23 | 2022-04-01 → 2025-12-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 24 | 24 | 2025-09-01 → 2025-10-16 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightaware` | web.archive.org copy of flightaware.com/live/flight/TAIL | 7 | 7 | 2011-12-20 → 2015-10-18 |
