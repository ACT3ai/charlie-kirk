...
**14 files across 4 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsbexchange-samples` | samples.adsbexchange.com | 9 | 9 | 2022-12-01 → 2026-03-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 3 | 3 | 2026-04-26 → 2026-05-12 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightradar24` | web.archive.org copy of flightradar24.com/data/aircraft/TAIL | 1 | 1 | 2022-08-31 → 2022-08-31 |
