...
These two accounts of when SU-BND left — "three hours after" versus a September 13 departure — are not fully consistent in the source material, and both are reported here as competing claims rather than settled fact.
...
3. Which departure account is correct — a departure roughly three hours after the assassination, or the September 13 Provo → Goose Bay → Paris → Cairo routing?
