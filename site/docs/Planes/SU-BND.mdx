...
* **Part of a larger fleet:** Trackers say SU-BND is one of **at least five Egyptian Air Force jets** (alongside SU-BTT, SU-BTU, SU-BTV, and SU-BGM) that they allege cycled in and out of Provo around the event — the cluster X researchers call the ["Egyptian Plane Armada"](/Planes/Egyptian-Armada). The fleet count is the trackers' claim, not an official tally.
