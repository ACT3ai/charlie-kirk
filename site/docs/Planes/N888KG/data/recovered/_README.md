...
**52 files across 6 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 4 | 4 | 2025-09-07 → 2025-10-09 |
| `adsbexchange-samples` | samples.adsbexchange.com | 13 | 13 | 2022-03-01 → 2026-02-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 12 | 12 | 2025-09-07 → 2026-05-28 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightaware` | web.archive.org copy of flightaware.com/live/flight/TAIL | 9 | 9 | 2011-07-04 → 2025-09-11 |
| `wayback/flightradar24` | web.archive.org copy of flightradar24.com/data/aircraft/TAIL | 13 | 8 | 2025-09-11 → 2026-01-28 |
