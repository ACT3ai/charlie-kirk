...
**44 files across 4 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 5 | 5 | 2025-09-03 → 2025-10-11 |
| `adsbexchange-samples` | samples.adsbexchange.com | 12 | 12 | 2022-02-01 → 2026-08-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 26 | 26 | 2025-09-03 → 2026-05-29 |
