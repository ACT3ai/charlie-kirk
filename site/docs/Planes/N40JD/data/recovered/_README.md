...
**35 files across 5 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 10 | 10 | 2025-09-02 → 2025-09-16 |
| `adsbexchange-samples` | samples.adsbexchange.com | 11 | 11 | 2022-06-01 → 2026-04-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 12 | 12 | 2025-09-02 → 2025-10-16 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightradar24` | web.archive.org copy of flightradar24.com/data/aircraft/TAIL | 1 | 1 | 2022-05-22 → 2022-05-22 |
