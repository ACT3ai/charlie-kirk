...
**55 files across 5 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 19 | 19 | 2023-05-03 → 2025-09-15 |
| `adsbexchange-samples` | samples.adsbexchange.com | 6 | 6 | 2022-01-01 → 2026-07-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 27 | 27 | 2023-05-03 → 2026-06-04 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightradar24` | web.archive.org copy of flightradar24.com/data/aircraft/TAIL | 2 | 2 | 2025-10-12 → 2025-11-18 |
