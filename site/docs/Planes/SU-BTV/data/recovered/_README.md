...
**11 files across 4 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 1 | 1 | 2025-10-11 → 2025-10-11 |
| `adsbexchange-samples` | samples.adsbexchange.com | 2 | 2 | 2022-10-01 → 2025-10-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 7 | 7 | 2025-10-11 → 2026-05-24 |
