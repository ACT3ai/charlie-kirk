...
Note: tail 99-0404 also appears under the primary callsign **SAM702** on the [SAM 99-0404 Flight](/Planes/SAM-99-0404) page. SAM-000 and [SAM-112](/Planes/SAM-112) are the two alternate callsigns reported for the same flight. They are documented separately here at the request of the investigation, but readers should treat all three as candidate identifiers for one government VIP aircraft until the official record resolves which is correct.
