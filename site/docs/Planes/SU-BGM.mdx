...
The only tail-specific legs published for SU-BGM come from a single raw-flight-log thread (attributed to [@WeAre_TheElite](/Influencers/x/weare-theelite) and amplified by [@ProjectConstitu](/Influencers/podcasts-project-constitution) / Project Constitution and Sam Parker). They describe **spring 2025** activity, not the September window:
