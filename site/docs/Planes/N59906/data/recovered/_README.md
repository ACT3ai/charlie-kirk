...
**63 files across 6 sources.**

## What is in here, by source

| Source | Where it came from | Files | Days | Covers |
|---|---|---|---|---|
| `adsb-lol` | adsb.lol/globe_history | 9 | 9 | 2025-09-01 → 2025-10-08 |
| `adsbexchange-samples` | samples.adsbexchange.com | 23 | 23 | 2022-02-01 → 2026-07-01 |
| `airplanes-live` | globe.airplanes.live/globe_history | 26 | 26 | 2025-09-01 → 2026-05-31 |
| `flightaware-activity-log` | flightaware.com/live/flight/IDENT | 1 | 0 | — |
| `wayback/flightaware` | web.archive.org copy of flightaware.com/live/flight/TAIL | 2 | 2 | 2022-08-30 → 2022-09-01 |
| `wayback/flightradar24` | web.archive.org copy of flightradar24.com/data/aircraft/TAIL | 2 | 2 | 2022-08-29 → 2022-08-30 |
