...
The photo archive holds 1676 images filed into 27 concept clusters. Open a cluster to see its images and its sub-areas; every image has its own page with a full-size view and a write-up.

<div style={{ display: "flex", justifyContent: "space-between", gap: "2rem" }}>
<div style={{ flex: 1 }}>

* [FBI](/Photos/FBI/overview) — 24 images
* [The Shot and the Shooter Position](/Photos/Shot_Position/overview) — 74 images
* [Unfiled Backlog](/Photos/Unfiled_Backlog/overview) — 355 images
* [Patsy Candidates](/Photos/Patsy/overview) — 63 images
* [Security Team](/Photos/Security_Team/overview) — 28 images
* [TPUSA](/Photos/TPUSA/overview) — 14 images
* [Court and Legal Proceedings](/Photos/Court_Legal/overview) — 42 images
* [Aircraft and Flight Evidence](/Photos/Aircraft/overview) — 205 images
* [Tyler Robinson](/Photos/Tyler_Robinson/overview) — 140 images
* [Memes and Commentary](/Photos/MEMEs_2/overview) — 4 images
* [Ballistics and the Gun](/Photos/Ballistics_Gun/overview) — 91 images
* [The UVU Venue](/Photos/UVU_Venue/overview) — 49 images
* [Charlie Kirk Himself](/Photos/Charlie_Kirk/overview) — 46 images
* [People of the Investigation](/Photos/People/overview) — 93 images

</div>
<div style={{ flex: 1 }}>

* [The Microphone](/Photos/Mic/overview) — 56 images
* [CIA and US Intelligence](/Photos/CIA_Intelligence/overview) — 66 images
* [Google Search Evidence](/Photos/Google_Search/overview) — 97 images
* [The Table and Charlie](/Photos/Table_And_Charlie/overview) — 89 images
* [Maps and Site Geometry](/Photos/Maps/overview) — 28 images
* [Israel and Mossad](/Photos/Israel/overview) — 37 images
