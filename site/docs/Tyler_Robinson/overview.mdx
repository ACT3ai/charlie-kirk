...
description: "This page consolidates key claims, timelines, and legal notes related to Tyler Robinson in connection with the Sept 10, 2025 UVU incident involving Charlie…"
keywords:
  - Charlie Kirk
...
- Morning sightings attributed to law-enforcement/campus cameras and residential cameras, as described in publicly discussed doorbell and surveillance footage (camera-by-camera breakdown on [Surveillance Cameras](/cameras/overview): [Ring](/cameras/Ring), [WYZE](/cameras/WYZE), [UVU surveillance](/cameras/UVU_Surveillance); full list on [Tyler on Surveillance Cameras](/cameras/Tyler_On_Cameras)):
...
* Robinson's cell-site location records and the chain of custody of the recovered rifle and the full TPUSA and UVU camera archives are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
