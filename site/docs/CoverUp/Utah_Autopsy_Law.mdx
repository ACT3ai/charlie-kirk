...
* **An unverified "second appointee" claim.** Separate, uncorroborated posts assert that a person named **Angela Hammond** was "newly appointed as the Utah Medical Examiner in September 2025, shortly before the incident." Investigation notes flag that "no official records or news confirm this appointment or her role in the case," and that the name "only appears in unverified X posts." It is recorded here only because it recurs; it is not established fact.
