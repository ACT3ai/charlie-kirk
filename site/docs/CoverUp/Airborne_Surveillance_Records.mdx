...
* The **HADES** program (an Army high-altitude ISR effort) is described as run out of **Biggs Army Airfield**, and the master file states that **Bradley Hansell** is the program lead — an assertion in the source notes that this site has not independently confirmed against any official Army organizational record.
