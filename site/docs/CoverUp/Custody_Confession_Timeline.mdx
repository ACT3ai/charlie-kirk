...
* **Washington County Sheriff Nate Brooksby** — the official who reportedly received the surrender tip and gave the ~8:02 PM call account — later **resigned**. Coleman refers to him as "the now disgraced former sheriff of Washington County," and commentators ask why the person at the center of the disputed surrender narrative left office.
* **UVU President Astrid S. Tuminez** — some posts note that the university's president also **resigned** in the same period, and pair the two departures as, in their words, "strange" timing.
