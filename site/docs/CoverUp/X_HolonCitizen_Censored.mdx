...
**The X account @HolonCitizen, which publishes Charlie Kirk investigation content, reportedly shows demonetization and reduced-reach indicators (including a reported paid-promotion experiment that under**

### Claims and discussions circulating (do not treat as proven)

X @HolonCitizen demonetize/throttle claims.
