...
- **A government VIP flight overhead.** Some posts assert a flight associated with Secretary of Defense **[Pete Hegseth](/People/pete-hegseth)** (cited by tail number **99‑0404**, callsign **[SAM702](/Planes/SAM-702)**) passed over the AES facility, allegedly at reduced altitude. Mr. Hegseth has not been shown to have any connection to the blast; this is presented as an unverified observation.
...
* [SAM702](/Planes/SAM-702) reportedly left Fort Huachuca on September 9, the day before Utah Valley University.
