...
* Post by @matt82704417 (Matthew St Baker), June 21, 2026, amplifying Jon Bray's 4K shirt-tracking as a claimed frame-by-frame device path — https://x.com/matt82704417/status/2068506485420892470 (reported social-media interpretation; not authenticated).
* Skeptic shaped-charge demonstration circulated by @troofevades quote-tweeting @Trillion0x ("that's a lot of smoke that I don't see at the CK event"), offered as evidence a real shaped charge leaves a large smoke/blast signature — https://x.com/troofevades/status/2071072788132118610 (proponents counter that any device would be a micro-charge/EFP, not a breaching charge).
