...
Why that gap matters is a question about how ordinary businesses keep records, not about anyone's conduct. Mailboxes on a thirty-, sixty- or ninety-day automatic-deletion policy quietly destroy exactly the category-17 correspondence a rider like this asks for, and they do it on a schedule nobody has to think about. Rental inventory is re-tagged and redeployed to the next booking within days. Small-parcel carriers commonly retain proof-of-delivery signature images on a rolling window measured in months, not years, before purging them. None of that is irregular. All of it is irreversible, and none of it is stopped by an order aimed at a prosecutor's office.
