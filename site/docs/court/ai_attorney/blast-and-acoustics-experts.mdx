...
Defense expert work is confidential and need not be disclosed unless the expert testifies. It is entirely possible that both experts have been retained, have reported, and have given counsel an answer it prefers not to use yet — in which case the correct professional decision is to bury the reports and never mention them again. That scenario is indistinguishable from the outside.
