...
**UVU After-Action Report:** The report says campus video was used "more effectively as a post-incident investigative resource than as a real-time situational awareness tool," and that no one watched the feeds live. Its physical-security section describes the camera and alert systems a defense subpoena would target.

<a href="/reports/uvu-after-action-report/#p83" style={{display:'inline-block', marginTop:'0.3rem', padding:'0.85rem 1.6rem', background:'#0b5c8a', color:'#fff', borderRadius:'8px', fontSize:'1.1rem', fontWeight:700, textDecoration:'none', boxShadow:'0 3px 10px rgba(0,0,0,.25)'}}>📄 Open the UVU After-Action Report →</a>&nbsp;&nbsp;<a href="/UVU/After_Action_Report" style={{fontSize:'0.95rem'}}>What people are contesting</a>
...
* [The Missing Minutes: Timestamp Jumps in the UVU Camera Exhibit](/Videos/Vid_Surveillance_Cameras/Vid_Surveillance_Camera_Footage/Vid_Blake_Bednarz_Missing_Minutes_2089500)
