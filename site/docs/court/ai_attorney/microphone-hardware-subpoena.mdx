...
If the alternative theory of this case is right, the murder weapon is not a rifle. It is a **microphone**, and it is an object with a make, a model, a serial number, a purchase order, a shipping route and a named person who clipped it on. We assume that every TPUSA employee and every audio-visual contractor working at UVU that day had no knowledge of any explosive that may have been in the mic, even if they handled the mic.
