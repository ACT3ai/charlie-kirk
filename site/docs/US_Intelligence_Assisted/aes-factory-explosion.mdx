...
- **Security-button / shirt-first + AES lag.** [@DShox1](https://x.com/DShox1) (July 10, 2026) alleges Charlie’s shirt moves first “exactly at the point his security seems to press a button,” reading that as a mic firing source, and only later connected AES’s shaped-charge plant exploding a month after UVU.
