...
- **[Stew Peters](/Mic/Stew_Peters_Broke_AES_Mic)**: presents himself as having broken the exploding-mic-plus-AES-order story before the plant disaster and later sequences Joe Kent's foreign/military questions with Huachuca activity, JTF personnel actions, and the AES blast.
