...
* NSA SIGINT queries tied to the aircraft and people and the N1098L HADES surveillance flight orders and the drone flight and video-feed recipients over UVU are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
