...
* NSA SIGINT queries on the case figures and planes and platform takedown orders naming the case and subscriber IDs of the ~12 foreign phones at UVU are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
