...
* Who authorized paving over the crime scene and the signed contractor work orders and pre-destruction trace and explosive-residue testing of the tent area are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
