...
- **Deed chain & instrument numbers** — [Utah County Recorder](https://www.utahcounty.gov/landrecords/32916/Property.asp?av_serial=362140001002) grantor/grantee index, to document the Theobald → UVU transfer and any later change. See [Ownership](./ownership).
- **Assessor valuation & tax status** — Utah County Assessor, to check the residential-exemption signal and mailing address.
- **UVU / Regents board minutes** — the [2019 purchase records](https://www.utah.gov/pmn/files/504485.pdf) are already public and posted online.
