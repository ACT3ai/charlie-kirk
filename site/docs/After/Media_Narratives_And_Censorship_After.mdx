...
borderRadius:'4px', textDecoration:'none', fontSize:'0.9rem'}}>← After the Shooting</a>
...
* records of FBI agents asking witnesses to delete videos and remotely wiped 4K eyewitness footage of the shot and platform takedown orders targeting intel-service theories are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
