...
description: "Timeline on Sept 10th: Summary, Full Detail. Timeline by Year: evidence and analysis from the Timeline section of the Who Assassinated Charlie Kirk citizen…"
keywords:
  - Charlie Kirk
...
- 8:07–11:49 AM MDT: [Tyler Robinson](/People/tyler-robinson) observed on multiple cameras near UVU; outfit change reported (as summarized from doorbell and security footage).
- ~11:47 AM MDT: U.S. Army ISR jet [N1098L](/Planes/N1098L/overview) (HADES) is reported by aviation trackers to conduct a low-altitude pass near Utah Lake (timing varies in sources).
...
- Evening (claims): Private jet [N888KG](/Planes/N888KG) departs PVU and, according to flight-tracking commentary, disables ADS-B mid-flight before later returning.
...
- Jul 20: Israel/Egyptian Air Force [SU-BTT](/Planes/SU-BTT)'s first U.S. trip; same-day military/foreign leaders meeting in U.S.
...
- Dec 8–14, 2024: Reported spike in searches for attorney [Kathryn Nester](/People/kathryn-nester) (from Israel), per research notes.
...
- Jul 11–13: Megyn Kelly & [Charlie Kirk](/People/charlie-kirk) at [TPUSA](/TPUSA/overview) SAS (Tampa, FL) ([YouTube](https://www.youtube.com/watch?v=ccRNaLGavf8)).
...
- Jul 20: Israel/Egyptian Air Force Gulfstream (SU-BTT) reportedly makes its first U.S. trip (to a U.S. Army base in Nebraska); same day, a military meeting with foreign leaders occurs on U.S. soil.
- Jul 31: WH meeting organized by Faith & Freedom Coalition, Latino Coalition for Israel, and the Philos Project on confronting "woke-right" narratives; attendees reportedly include [Ralph Reed](/People/ralph-reed), [Luke Moon](/People/luke-moon), [Mario Bramnick](/People/apostle-mario-bramnick), [Yehuda Kaploun](/People/yehuda-kaploun), and [Yair Netanyahu](/People/yair-netanyahu). TPUSA not present.
- Early Aug (~Aug 4): "Hamptons intervention" where pro-Israel figures confront Kirk (names reported include [Pesach Wolicki](/People/rabbi-pesach-wolicki), [Josh Hammer](/People/josh-hammer), [Seth Dillon](/People/seth-dillon), [Bill Ackman](/People/bill-ackman), [Natasha Hausdorff](/People/natasha-hausdorff)).
...
* The N1098L flight tasking logs across the day and the Israeli-IP search timestamps from December 2024 and the Fort Huachuca meeting records before the shooting are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.


## Citizen Investigator Claims on X

Year-grid presentations help readers see **2024 aviation/politics** vs **2025 pressure/assassination** vs **2026 court/OSINT**.

- X long-form accounts often collapse years into a single conspiracy arc; this page should resist collapse and keep year buckets.

## Open Questions Raised by Investigators

1. Best primary source per year-bucket entry?
2. Which items are duplicated across year pages and should cross-link only once?
