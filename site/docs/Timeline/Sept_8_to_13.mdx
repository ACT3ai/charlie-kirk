...
sidebar_position: 3
description: "All times Mountain Time (MT). Events are drawn from court filings, surveillance records, law enforcement statements, and public reporting. Claims and…"
keywords:
  - Charlie Kirk
...
- [Charlie Kirk](/People/charlie-kirk) posts publicly about distancing from the pro-Israel movement.
...
- 7:08 AM: Plane tail [SU-BTT](/Planes/SU-BTT) (Israel/Egyptian Air Force Gulfstream) departs Utah for Wilmington, DE.
- 8:07 AM: Ring doorbell camera captures [Tyler Robinson](/People/tyler-robinson) walking on S 800 W toward UVU campus,
...
- ~11:47 AM: U.S. Army ISR jet [N1098L](/Planes/N1098L/overview) (HADES) reported at low altitude near Utah Lake
...
- 12:24 PM: Suspect runs north across Campus Drive. Investigators later discover a Mauser Model 98
  ...
  Cartridge casings with engraved inscriptions found with the rifle. Per Deseret News (quoting
  Governor Cox) and LiveNOW from FOX, the **fired casing** read *"Notices, bulges, OwO what's this?"*
  and the three **unfired casings** read *"Hey fascist! CATCH!"* (with up, right, and three down
  arrow symbols), *"O Bella ciao, Bella ciao, Bella ciao, Ciao, ciao!"* (the anti-fascist anthem),
  and *"If you read this, you are gay LMAO."* Defense filings note the engravings are consistent
  with a rotary tool such as a Dremel.
...
- 1:02 PM: [President Trump](/People/donald-trump) shares news of the shooting on Truth Social.
...
- 4:00 PM: Governor [Spencer Cox](/People/spencer-cox) holds a press conference calling it a "political assassination."
...
- Evening: Private jet [N888KG](/Planes/N888KG) departs Provo Municipal Airport; ADS-B transponder disabled
...
- 6:25 PM: Tyler Robinson is read his Miranda rights by law enforcement.
  ...
  "I would like to speak with my legal counsel. I'm hoping for a fellow in Utah named [Doug Terry](/People/doug-terry)."
...
- 7:45 PM (approx.): Air Force Two carrying Charlie Kirk's casket lands at Phoenix Sky Harbor
  Airport. Widow [Erika Kirk](/People/erika-kirk), VP [JD Vance](/People/jd-vance), and Second Lady Usha Vance aboard.
...
- ~12:30 AM: After approximately 2.5 hours at the Washington County Sheriff's Office, Robinson
  is transferred to FBI custody. Utah County investigators (including Officer [Brian Davis](/People/brian-davis)) have
...
* Flight manifests for the SU-BTT Israel/Egyptian jet and N1098L HADES plane and who received Kirk's "they are going to kill me" texts and the timestamped Mirandizing video before the Discord messages are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.


## Citizen Investigator Claims on X (2026 refresh)

The Sept 8–13 window is the most shared compressed timeline on X:

1. **Sep 8** — donor-loss / “leaving pro-Israel cause” group-chat claims (**@AdameMedia**).
2. **Sep 9** — high-pressure meeting + “they are going to kill me” texts (Kolvet / Flood / Turek lanes).
3. **Sep 10** — UVU assassination.
4. **Sep 11** — surrender / Mirandize controversies; Therese Bible College “no plan” security claim.
5. **Sep 13–14** — scene alteration / paving window claims.

Grok-circulated counters emphasize private venting vs public withdrawal and the official lone-shooter package. Record both.

## Counter-Claims and Debunk Attempts

Skeptics of the orchestration reading argue coincidence of political stress and a charged domestic shooter. Proponents argue the text language + meeting density + security gaps exceed coincidence. This site maps the dispute; it does not declare a conspiracy proven.
