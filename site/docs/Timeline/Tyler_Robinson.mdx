...
sidebar_position: 3
description: "Timeline of Tyler Robinson's documented movements across the Charlie Kirk assassination case. All times Mountain Time (MT)."
keywords:
  - Charlie Kirk
...
Timeline of [Tyler Robinson](/People/tyler-robinson)'s documented movements across the [Charlie Kirk](/People/charlie-kirk) assassination case.
...
- **7:08 AM** — [SU-BTT](/Planes/SU-BTT) (Israel/Egyptian Air Force Gulfstream) departs Utah for Wilmington.
...
- **6:25 PM** — Robinson is **Mirandized**. Invokes right to counsel ([Doug Terry](/People/doug-terry)) and right to remain silent. No questioning occurs.
...
- **7:18 AM** — Probable Cause entered by Officer [Brian Davis](/People/brian-davis) (Utah AG). Probable Cause ID: 189904.
...
* The SU-BTT passenger manifest for the 7:08 AM Provo departure and cell tower data tracing Robinson's movements and the recipients of Kirk's "they are going to kill me" text are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.


## Citizen Investigator Claims on X

Robinson-centric timelines on X fight over roof access feasibility, clothing mismatch, confession/Mirandize order, and family/sheriff-friend identification path.

- **@ProjectConstitu** all-black package argues the public Robinson image never matched dispatch.
- Official exhibits (as reported) cite rooftop video, DNA, texts — still **charges**, not a completed conviction narrative for this site’s voice.

## Open Questions Raised by Investigators

1. Exact time-stamped path from alleged roof to custody?
2. When was Miranda administered relative to any quoted confession language?
