---
title: "Egypt Flight Departure Analysis"
sidebar_label: "Egypt Flight Departure Analysis"
description: "The Egypt flight departure refers to SU-BTT's return journey from the United States to Cairo, Egypt, following the Charlie Kirk assassination. This flight…"
keywords:
  - Charlie Kirk
...
* SU-BTT's crew and passenger manifest leaving for Cairo and the mission authorization for its US operations and CBP exit records for the Egyptian nationals aboard are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
