---
title: "Flight Records Analysis"
sidebar_label: "Flight Records Analysis"
description: "The flight records analysis examines the comprehensive flight tracking data for all aircraft involved in the Charlie Kirk assassination investigation…"
keywords:
  - Charlie Kirk
...
* N1098L crew, mission authorization and drone feed recipients and passenger manifests for SU-BTT and SU-BND and the Minot AFB and Provo Airport meeting records are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
