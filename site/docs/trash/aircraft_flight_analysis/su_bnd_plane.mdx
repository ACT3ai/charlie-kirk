---
title: "SU-BND Plane Analysis"
sidebar_label: "SU-BND Plane Analysis"
description: "SU-BND is a Gulfstream IV-SP (serial number 1332) operated by the Egyptian Air Force. This aircraft was present at Provo Municipal Airport (PVU) during the…"
keywords:
  - Charlie Kirk
...
borderRadius:'4px', textDecoration:'none', fontSize:'0.9rem'}}>← Aircraft Flight Analysis</a>

# SU-BND Plane Analysis

## Overview
[SU-BND](/Planes/Egyptian-Armada) is a Gulfstream IV-SP (serial number 1332) operated by the Egyptian Air Force. This aircraft was present at Provo Municipal Airport (PVU) during the Charlie Kirk assassination on September 10, 2025, raising significant questions about its purpose and timing.
...
- Coordination with other aircraft (SU-BTT, [N1098L](/Planes/N1098L/overview))
...
* The SU-BND crew manifest and mission authorization and CBP entry records for its Egyptian nationals and who ran the Israeli-IP search for SU-BND are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
...
* [Aircraft Flight Analysis Overview](/trash/aircraft_flight_analysis/overview)
* [Egypt Flight Departure Analysis](/trash/aircraft_flight_analysis/egypt_flight_departure)
* [Wilmington Flight Timeline Analysis](/trash/aircraft_flight_analysis/wilmington_flight_timeline)
