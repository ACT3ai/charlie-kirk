...
* TPUSA donor and funding disclosure records and financial flows tied to the reported donor pressure and communications about Kirk's Israel platforming disputes are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
