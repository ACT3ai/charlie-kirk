...
* Government takedown requests sent to the platforms and the platforms' case-content moderation logs and deleted Google search records tied to the investigation are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
