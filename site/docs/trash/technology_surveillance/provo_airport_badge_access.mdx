...
* the Provo Airport badge-access and entry logs and who badged in the foreign nationals at Provo and deleted Provo Airport surveillance footage are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
