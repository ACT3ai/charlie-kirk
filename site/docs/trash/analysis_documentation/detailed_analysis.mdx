---
title: "Detailed Analysis of the Charlie Kirk Assassination"
sidebar_label: "Detailed Analysis of the Charlie Kirk Assassination"
description: "This detailed analysis provides a comprehensive examination of the Charlie Kirk assassination, focusing on the technical, political, and intelligence aspects…"
keywords:
  - Charlie Kirk
...
borderRadius:'4px', textDecoration:'none', fontSize:'0.9rem'}}>← Analysis Documentation</a>
...
- **7:08 a.m. MDT**: [SU-BTT](/Planes/SU-BTT) departed Provo for Wilmington, Delaware
- **7:48 a.m. MDT**: [N1098L](/Planes/N1098L/overview) departed Biggs Army Airfield for Montana
- **9:16 a.m. MDT**: N1098L first low-altitude pass over UVU (203 feet AGL)
- **11:59 a.m. MDT**: [SU-BND](/Planes/Egyptian-Armada) transponder activated
...
* N1098L HADES flight crew and drone-feed recipients over UVU and SU-BTT and SU-BND passenger manifests and the sealed Robinson digital-forensics warrants are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
...
* [Analysis and Documentation Overview](/trash/analysis_documentation/overview)
