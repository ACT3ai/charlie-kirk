...
* Passenger manifests for SU-BTT and SU-BND and CBP entry/exit records for the foreign nationals aboard and NSA SIGINT intercepts tied to those aircraft are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
