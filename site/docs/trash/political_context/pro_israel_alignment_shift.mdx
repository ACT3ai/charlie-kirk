...
* Kirk's private messages about Israel and donors and TPUSA donor records around the Israel split and foreign-source financial transfers with CBP entry records are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
