---
title: "Military Intelligence and HADES Program"
sidebar_label: "Military Intelligence and HADES Program"
description: "The U.S. military's involvement in the Charlie Kirk assassination through the HADES program and other intelligence operations has raised serious questions…"
keywords:
  - Charlie Kirk
...
- **Aircraft**: Bombardier Global 6500 ([N1098L](/Planes/N1098L/overview))
...
* The N1098L HADES crew and mission tasking orders and who received its drone video feeds over UVU and the NSA SIGINT collected during its two descents are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
