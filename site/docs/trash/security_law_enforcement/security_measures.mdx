---
title: "Security Measures: Questions and Analysis in Public Commentary"
sidebar_label: "Security Measures: Questions and Analysis in Public Commentary"
description: "Nothing on this page constitutes a finding of wrongdoing, criminal conduct, negligence, or ethical violation by any security personnel, event staff, TPUSA…"
keywords:
  - Charlie Kirk
...
borderRadius:'4px', textDecoration:'none', fontSize:'0.9rem'}}>← Security & Law Enforcement</a>
...
For related context, see [TPUSA](/TPUSA/overview.mdx) and [Shooting Locations](/Suspects/Shooting_Locations).
...
* The pre-event UVU threat assessment and the withheld UVU surveillance camera feeds and records of who ordered rooftops left unguarded are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
