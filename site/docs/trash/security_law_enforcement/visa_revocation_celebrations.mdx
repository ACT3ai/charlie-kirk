---
title: "Visa Revocation Celebrations: Security and Law Enforcement Response"
sidebar_label: "Visa Revocation Celebrations: Security and Law Enforcement Response"
description: "The visa revocation celebrations following Charlie Kirk's assassination have become a significant aspect of understanding the security and law enforcement…"
keywords:
  - Charlie Kirk
...
* CBP entry and exit records for the foreign nationals and State Department visa-revocation case files and platform takedown logs for removed posts are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
