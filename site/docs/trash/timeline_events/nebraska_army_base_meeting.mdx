...
* The Nebraska base visitor and attendee logs and SU-BTT's flight manifest and passengers from that July 20 visit and the base's classified meeting records are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
