...
* the withheld UVU surveillance camera footage and who controlled rooftop access and security posture and geofence warrants for every phone at UVU are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
