---
title: "Tyler Robinson's Partner: Public Reporting Context"
sidebar_label: "Tyler Robinson's Partner: Public Reporting Context"
description: "Nothing on this page constitutes a finding of wrongdoing, criminal conduct, or ethical violation by Tyler Robinson's partner or any other living person…"
keywords:
  - Charlie Kirk
...
* The Discord and text messages cited in the official motive narrative and any financial wire transfers or SARs tied to this case and the underlying FBI 302 interview reports are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
