...
The recovered fragment, as reported, produced a **class-level, inconclusive** result — consistent with a .30-caliber projectile, not matched to *that* Mauser. The ATF's September 17, 2025 comparison is the hard limit: Exhibit 6A was **neither identified nor excluded** from Exhibit 1. July 2026 testimony (Karner) adds barrel dust/debris and a measured fragment diameter in the **.286–.301"** range. See [ATF fragment inconclusive](/Gun_Bullet/ATF_Fragment_Inconclusive), [ATF fragment class-only](/Suspicious/Cause_of_Death/atf-fragment-class-only), [barrel dust and diameter](/Gun_Bullet/Barrel_Dust_And_Diameter). Comparative bullet-lead analysis — a method the FBI abandoned in 2005 after the National Research Council found its inferences unsupportable — was then reached for. See [ballistics, ATF and CBLA](/court/ballistics-atf-cbla). Unidentified extra prints on the rifle, reported in OSINT and amplified by [Candace Owens](/Influencers/podcasts-candace-owens), are a separate "whose hands" question the state has not closed.
