...
Second, the State then sent the fragment to the FBI for **virtual comparison microscopy**. FBI notes described it as fragile, with detached pieces in its packaging. The defense reportedly asked for an independent expert or videotaping, and the FBI declined ([FBI ballistics](/FBI/Ballistics_Forensics)). Investigators also warn against a return of **bullet-lead composition matching**, which the FBI abandoned in 2005 as scientifically flawed ([sealed CBLA claims](/CoverUp/Ballistics_Sealed_CBLA)).
...
* **10 March 2026.** News-media coalition (Deseret News, *Salt Lake Tribune*, AP, NYT, Fox, CBS, and others) moved to unseal a defense motion discussing the four-page ATF report. Case **251403576**.
* **31 March – 2 April 2026.** Official-side push: NY Post, Forbes, PolitiFact, and allied commentators. Line: "inconclusive does not mean no match"; "conspiracy theories misuse a damaged fragment."
