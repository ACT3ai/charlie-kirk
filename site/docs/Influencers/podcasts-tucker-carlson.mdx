...
* Who blocked Joe Kent's foreign-involvement probe and the suppressed foreign leads the FBI buried and the intelligence files behind the lone-shooter narrative are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
