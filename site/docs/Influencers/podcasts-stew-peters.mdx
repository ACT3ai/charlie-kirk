...
attributed the identification of the alleged offeror to Candace Owens, naming **"a gentleman called Pierre
who is in Israel"** as reportedly among the first to publicly note awareness of Kirk's death and as the
party who had offered the money. Peters further claimed the funds were **accepted by Turning Point USA
...
reported **~$440,000 DoD order to Accurate Energetic Systems (AES)**. The master file notes the AES
facility **exploded on October 30, 2025**, killing those inside; Peters connected the timing — and a
flight he identifies as Defense Secretary Pete Hegseth's (tail no. **99-0404**, callsign **SAM702**)
