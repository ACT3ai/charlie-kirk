...
The Shawn Ryan Show Episode **254** interview with Brian Harpole (described as Kirk's head of security) remains the single most-cited primary security interview. X user [@Trillion0x](https://x.com/Trillion0x) (July 2026) called Harpole's description of a **decentralized command structure using a messaging app for security plans** the "most overlooked" item — comparing it to "Signalgate" and asking who was in the group chat. That is **commentary**, not a finding that messaging caused the death.
