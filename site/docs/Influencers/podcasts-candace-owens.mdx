...
* Subscriber identities behind the Israeli cellphone signals near UVU and TPUSA donor financial records and full FBI files handed to a Designated Trusted Investigator are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
