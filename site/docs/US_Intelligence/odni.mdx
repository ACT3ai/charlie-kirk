...
* who ordered the NCTC foreign-nexus inquiry shut down and the NCTC's classified foreign-involvement findings and NSA signals intelligence on the phones, planes and addresses are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
