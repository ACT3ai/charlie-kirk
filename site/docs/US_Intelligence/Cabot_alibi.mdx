...
<div style={{float: 'right', width: '48%', maxWidth: '480px', marginLeft: '1.5rem', marginBottom: '1rem'}}>
  <video controls style={{width: '100%', height: 'auto', display: 'block', borderRadius: '4px'}}>
    <source src="http://127.0.0.1:8080/ipfs/QmYjH2fYpeCVoLK3pb3ppfeskKSP2Hjw3rToq2q945fe2Q" type="video/mp4" />
...
<div style={{float: 'right', width: '48%', maxWidth: '480px', marginLeft: '1.5rem', marginBottom: '1rem'}}>
  <div style={{display: 'flex', flexWrap: 'wrap', gap: '0.5rem'}}>
    <img
      src="http://127.0.0.1:8080/ipfs/QmRAQWmcd6nAEdFZuHPowY2MNT1m71HnFYyEDcumdDMime"
    ...
    />
    <img
      src="http://127.0.0.1:8080/ipfs/QmZv3tnVjzdKU2uviSdti8ips1oQ3amPMxvVrTCLYB5Lgf"
    ...
    />
    <img
      src="http://127.0.0.1:8080/ipfs/QmVMBu1YDVFesVp3eom4RZ16ZdfzV9wWssUDKJFTeK2bdc"
    ...
    />
    <img
      src="http://127.0.0.1:8080/ipfs/QmYEy93b6qqAgX4ni3JKwDCWmunPHC5BThKqhC4zQK2SM9"
...
* [SAM 99-0404 — Fort Huachuca aircraft](/Planes/SAM-99-0404)
* [Planes and aviation assets](/Planes/overview)

</div>
<div>

* [Influencer coverage of the assassination](/Influencers/podcasts)
