...
title: "CIA"
sidebar_label: "CIA"
description: "This page documents claims and questions about possible CIA involvement that appear in public commentary about the Charlie Kirk assassination. All theories…"
keywords:
  - Charlie Kirk
...
This page documents claims and questions about possible CIA involvement that appear in public commentary about the Charlie Kirk assassination. All theories here are presented as investigative hypotheses — lines of inquiry supported by evidence patterns, not adjudicated findings. The CIA has not been officially investigated in connection with the killing.
...
- **Aerial platforms and operational signatures** — The flight behavior of assets like [N1098L](/Planes/N1098L/overview) and the operational characteristics of the assassination itself resemble capabilities associated with intelligence or defense communities rather than a lone actor. See: [Planes](../Planes/overview)
...
## HADES Program and N1098L (Claims)

Public commentary and flight-tracking research tie the U.S. Army **HADES** program (High Accuracy Detection and Exploitation System) to [N1098L](/Planes/N1098L/overview), a Bombardier Global 6500 operated by LASAI Aviation II LLC (a Leidos subsidiary). The aircraft is documented as carrying deep sensing, SIGINT, ELINT, and drone-deployment capabilities.

On September 10, 2025, ADS-B data cited by investigators shows two low-altitude passes near the UVU/Orem corridor — one roughly three hours before the shooting and another approximately 20–28 minutes after. Some analysts interpret the first pass as possible drone deployment and the second as retrieval; others describe both as routine ISR training. **These interpretations are contested claims, not confirmed mission descriptions.**

Sources from the [NCTC](/US_Intelligence/nctc) context have been cited in commentary suggesting rogue CIA elements may share operational signatures with other high-profile incidents. That account is secondhand and unverified.

For full flight data, competing theories, and open questions, see [N1098L Spy Plane](/Planes/N1098L/overview) and [ISR Program Context](/Planes/ISR-Operations).
...
* N1098L HADES flight crew and drone-feed recipients over UVU and NSA XKeyscore SIGINT queries on the case figures and congressional oversight records of any domestic operation are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
...
* [Cabot alibi & Fort Huachuca](/US_Intelligence/Cabot_alibi)
