...
* Who ordered the NCTC foreign-nexus inquiry shut down and the ODNI records of that inquiry and her office's reply on the alleged Macron directive are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
