...
* FBI and DOJ case files and CIA and NSA records tied to the event and which agencies had agents at UVU are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
