...
Separately, **@JOKAQARMY1** and others frame the **12 foreign cell phones** as content **Joe Kent** was allegedly restricted from discussing on the **Alex Jones** show — a free-speech / process claim that belongs with [Leads to Foreign Involvement](/Israel_Main_Suspect/leads-to-foreign-involvement) and Kent's NCTC narrative. Whether a show "banned" a topic does not prove the phones exist; it only documents that presence claims were treated as politically radioactive.
