...
- Law 1 — law-enforcement records disclosure that depends on digital evidence being preserved in the first place.
- [Law 2](/laws/US_Intel/Law_2_US_Intel) — intelligence-community records disclosure, including signals-intelligence outputs.
- Law 3 — mandatory investigation that would rely on intact digital evidence.
