...
- Designated Trusted Investigator teams (see [Law 4](./Law4)).
...
- [Law 1](./Law1) and [Law 2](./Law2) — records-disclosure statutes that rely on insiders to flag evidence of selective search or withholding.
- [Law 3](./Law3) — mandatory investigation that benefits from a protected volunteer channel.
- [Law 4](./Law4) — trusted-investigator teams that would serve as one of the protected channels.
