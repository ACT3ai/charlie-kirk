...
Across compiled research notes — drawing on public sources such as social-media posts and videos by commentators including [Candace Owens](/People/candace-owens) and investigative accounts like Project Constitution (@ProjectConstitu), as well as articles from outlets like The Grayzone and the Daily Mail and publicly available legal documents — citizen-investigators repeatedly point to concerns such as:
