...
- [Law 4](./Law4) — independent civilian investigator oversight to verify that the investigation is complete.
- [Discovery Rights](./Discovery_Rights) — extending Brady-style disclosure obligations to federal agencies as custodial parties.
