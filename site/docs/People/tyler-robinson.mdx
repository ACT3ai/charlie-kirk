...
- **Trial personnel**: **Judge Tony Graf** (no bail Sept 16, 2025; gag order Dec 16, 2025); lead defense **Kathryn Nester** with co-counsel Michael Burt and Richard Novak; prosecution team Jeffrey Gray, Chad Grunander, and Christopher Ballard (June 2026 contempt over TMZ/Fox statements per [court press](/Media/tyler-robinson-trial-press)).
