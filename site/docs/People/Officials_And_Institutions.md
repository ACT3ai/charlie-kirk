...
- **FBI Salt Lake City leadership (as reported):**  
  ...
  - Bohls is reported to have led an **early press conference** on the shooting. Commentary sometimes speculates about the timing of these leadership changes; such speculation is explored as **claims** in sections like [FBI](/FBI/overview.md) and [Motive](/Motive/overview.md).  
...
- **Local and campus law enforcement (as reported):**  
  ...
  - Details of their deployment and actions are discussed in [Security & Law Enforcement](/security_law_enforcement/overview.md) and [Before](/Before/overview.md).
...
- **Judge Tony F. Graf Jr. (as reported):**  
  ...
  - He has issued orders relating to **scheduling, discovery, and gag orders**, which are discussed in [Tyler Robinson Trial](/Tyler_Robinson/Trial/overview.md) and [Legal Process, Gag Orders, and Hearing Secrecy](../After/Legal_Process_Gag_Orders_And_Secrecy.md).  
- **Defense counsel (as reported):**  
  ...
  - Online debates about how and why they were appointed are covered as **commentary**, not fact, in sections like [Motive](/Motive/overview.md) and [Timeline](/Timeline/overview.md).  
- **Prosecutors and other court actors (as reported):**  
  - Various Utah County prosecutors and court staff appear in case documents and media summaries. Their roles are described in [Legal Investigation](/legal_investigation/overview.md) and [Tyler Robinson Trial](/Tyler_Robinson/Trial/overview.md) based on official records and reporting.
...
- **Utah state medical examiner (as reported):**  
  - Public sources identify **Dr. Deirdre Amaro** as Utah’s chief medical examiner, whose office is responsible for autopsies statewide. She is mentioned in connection with **autopsy‑related questions and Utah’s records laws**.  
  - Details about autopsy practice, including limits on public release, are explored in [Charlie Kirk Autopsy](../Charlie/Autopsy.md), [Autopsy Law, Medical‑Examiner Practices, and Commentary](../Charlie/Autopsy_Law_Practices.md), and [Medical](/Medical/overview.md).  
- **Hospital administration (as reported):**  
  ...
  - Commentary sometimes speculates about the timing of his appointment; these views are treated as **claims**, not findings, in sections like [Medical](/Medical/overview.md) and [Timeline](/Timeline/overview.md).
...
- **Private security providers (as reported/claims):**  
  ...
  - Reports describe evolving relationships between TPUSA and these firms, with some commentary questioning staffing decisions before and on the day of the UVU event. These matters are discussed—carefully—as claims in [Security & Law Enforcement](/security_law_enforcement/overview.md), [Before](/Before/overview.md), and [Killer](/Killer/overview.md).  
