...
- **Utah state medical examiner (as reported):**  
  ...
  - Details about autopsy practice, including limits on public release, are explored in [Charlie Kirk Autopsy](../Charlie/Autopsy/overview), [Autopsy Law, Medical‑Examiner Practices, and Commentary](../Charlie/Autopsy/autopsy-law-sb0082), and [Medical](/Medical/overview).  
