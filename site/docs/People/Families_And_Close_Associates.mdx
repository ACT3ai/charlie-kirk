...
- **Mikey McCoy** — second-SUV / physician-parking claims (**@ProjectConstitu** hospital narrative). These remain **unverified claims** about intent and are not presented here as fact.
