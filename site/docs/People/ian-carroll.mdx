...
description: "Ian Carroll is a citizen journalist and independent investigator who has been one of the most active and prolific researchers into the Charlie Kirk…"
keywords:
  - Charlie Kirk
...
* The flight manifests for N1098L and the Egyptian SU-BTT and who issued the post-assassination threats to Carroll and the surveillance footage filling the gaps he documented are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
