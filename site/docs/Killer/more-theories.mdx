...
* The subscriber identities behind the foreign cell phones at UVU and any wire transfers to Tyler Robinson or Lance Twiggs and NSA SIGINT queries run on the suspects and planes are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
