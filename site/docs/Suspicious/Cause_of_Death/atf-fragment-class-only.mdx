...
| Raised by | Andrea Burkhart, who released the document; the defense's January 9 motion; @ProjectConstitu, who goes much further and calls the fragment planted |
...
* @ProjectConstitu for the planting claim, which the report does not support. **No direct URL for this specific post is cited in the file.**
