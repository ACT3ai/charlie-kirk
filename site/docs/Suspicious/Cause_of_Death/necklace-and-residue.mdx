...
3. Ask @cletus_jethro to publish his identity and credentials, and to state whether his anchoring objection means the microphone theory — which his own analysis is used to support — is wrong.
