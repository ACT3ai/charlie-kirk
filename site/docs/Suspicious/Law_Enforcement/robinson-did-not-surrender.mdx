...
**Mike Mitchell is a living private individual** who has not been charged with or found to have committed any wrongdoing, and nothing on this page should be read as an assertion that he did. The account below is **Candace Owens' characterization**, relayed secondhand; Mitchell's own account is not in the investigation file. **Tyler Robinson is charged, not convicted**, and has pleaded not guilty.
:::
