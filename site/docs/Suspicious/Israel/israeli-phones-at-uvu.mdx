...
| Raised by | Tony Seruga ([@TonySeruga](https://x.com/TonySeruga)), amplified by Candace Owens |
...
* X posts attributed to **Tony Seruga ([@TonySeruga](https://x.com/TonySeruga))**, reproduced in the investigation's master notes — the "44 foreign-registered cellphones" breakdown and the "Bumblehive / cross-pollination" explanation.
