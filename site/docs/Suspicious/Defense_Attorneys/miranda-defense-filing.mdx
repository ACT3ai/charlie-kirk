...
| Raised by | Baron Coleman (attorney and radio host), clipped by @Bechedith; Vicki Donahue (@VLuvMully); Aggelos Syrmos (@aggelos_syr) |
...
* Vicki Donahue (@VLuvMully), including images of the defense filing quoting Bates 003996-R2: [x.com/VLuvMully/status/2076019571127935010](https://x.com/VLuvMully/status/2076019571127935010)
* Aggelos Syrmos (@aggelos_syr), reply raising the "closed for the night" and missing-station-footage questions.
