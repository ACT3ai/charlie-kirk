...
* The same evening is the one to which compilations attribute the **"THEY ARE GOING TO KILL ME"** messages, during a combative meeting. Those are catalogued on [Reported Quotes and Warnings](/Charlie/Reported_Quotes_and_Warnings).
...
* **Erika Kirk** stated on Glenn Beck's show that Charlie was **not** messaging people the day before saying "they're going to kill me," that she had his phone, and that **"it never happened."** Multiple public figures — Kolvet, [Frank Turek](/People/frank-turek), Owens, Harrison Smith — have contradicted that. **This is a direct factual conflict between living people and it is unresolved.**
