...
Research notes in Charlie_Kirk.txt add two further reported details, both **unverified** and framed here strictly as claims, not findings. First, the notes describe **Butch Hibbs as being from Heber City, Utah** — the same regional airport from which independent researchers say a private flight departed for Nashville on **August 25, 2025** (see the [AES factory-explosion timeline](./aes-explosion-factory)). Second, some online investigators have circulated a "**two different Butch Hibbs at UVU**" claim and noted a family relationship to **Pastor [Jack Hibbs](/People/jack-hibbs)**, described in those posts as a PragerU-affiliated pastor. Charlie_Kirk.txt records the source's own uncertainty about these claims, and the object in the pocket is cited there as matching a **RØDE Wireless GO II (~2"×2")**; the exact model in the photo has not been independently confirmed. No wrongdoing by Butch Hibbs, Jack Hibbs, or any named person is alleged or implied.
...
- **@grok** (July 4, 2026): confirms product line is RØDE Wireless PRO; Australian manufacture; exploding-mic remains unverified speculation in that reply.
- **@grok** (July 6, 2026): battery energy insufficient for neck wound; rifle kinetic energy argument.
- **@realstewpeters**: tempered glass lav / shard framing in transport vehicle imagery.
