...
<div style={{display: 'flex', flexWrap: 'wrap', gap: '0.5rem'}}>
  ...
  <p style={{fontSize: '0.85rem', color: '#666', marginTop: '0.5rem'}}>
    <em>Screenshots of the @cletus_jethro thread laying out the shaped-charge crucifix argument and PETN blast math. Source: <a href="https://x.com/matt82704417/status/2068506485420892470">@matt82704417 on X</a>, June 21, 2026.</em>
  </p>
</div>
...
## Citizen Investigator Claims on X (Pendant / EFP Family)

- Early post-event theory space heavily featured **crucifix/pendant micro shaped charge** (Monroe effect) aimed at chest/neck — still referenced in CK investigation notes and Candace Owens commentary about intended chest hit vs neck outcome.
...
- **@alexboge** rejects both contact-explosive families as inconsistent with video and hearing autopsy GSW findings.
