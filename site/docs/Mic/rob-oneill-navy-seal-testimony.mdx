...
- Commentator **@alexboge** invokes shaped-charge engineering norms, while authors favoring a device theory point to the pager and Hezbollah supply-chain incident (the "Grim Beeper" case) as capability analogies. Capability, however, is not proof of use.
