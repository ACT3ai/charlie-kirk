...
## Citizen Investigator Claims on X (SEAL / Expert Commentary)

- Retired military voices on X/TV (including commentary associated with **Rob O’Neill** / SEAL-experience discussants on this page’s topic) are cited both for and against non-rifle mechanisms depending on clip selection.
- **@alexboge** invokes shaped-charge engineering norms; pro-device authors invoke pager/Hezbollah supply-chain precedent (Grim Beeper) as capability analogies — **capability is not proof of use**.
- Treat expert-sounding posts as **opinion evidence** unless sworn and cross-examined.
