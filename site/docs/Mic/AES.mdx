...
## Citizen Investigator Claims on X (AES)

*(Company context + attributed theories — not a finding that AES built a murder weapon.)*
...
- USASpending.gov contract research (paralegal account discussed on this page’s body) remains the strongest **public-document** leg; X posts often inflate contract language into proof of a Kirk-specific device. This site separates **contract exists** (documentable) from **used in UVU killing** (unproven).
