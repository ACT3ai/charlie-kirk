...
description: "This page describes the role of security camera systems in the Charlie Kirk investigation. It focuses on cameras located on or near the UVU campus and in…"
keywords:
  - Charlie Kirk
...
- [Shooting Locations](/Suspects/Shooting_Locations), [UVU](/UVU/overview), and [Maps](/maps/overview) – for spatial and trajectory analysis that relies on camera viewpoints.
...
* The unreleased UVU rooftop camera angles and chain-of-custody records for campus footage and who ordered any feeds withheld are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
...
* [UVU Security Cameras](/cameras/security/UVU_Security_Cameras)
* [Videos](/Videos/overview)
* [Photos](/Photos/overview)
