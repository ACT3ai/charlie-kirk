...
title: "Tent"
sidebar_label: "Tent"
description: "This page examines the event tent and its immediate surroundings at the UVU courtyard, as they relate to the shooting and subsequent site changes. It…"
keywords:
  - Charlie Kirk
...
- Shooter location and trajectory analyses (see [Shooting Locations](/Suspects/Shooting_Locations), [Killer](/Killer/overview), and [Timeline](/Timeline/overview)).
...
* Who authorized paving over the crime scene and the paving and landscaping work contracts and scheduling and explosive-residue testing of the tent and tunnel surfaces are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
