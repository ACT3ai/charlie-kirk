...
sidebar_label: "Ballistics and Wound Analysis"
description: "TOPIC: Bullet caliber, entry/exit path, wound characteristics, alternatives"
keywords:
  - Charlie Kirk
...
* The full autopsy report with wound trajectory and true caliber and barrel gunpowder-residue and explosive-residue test results and the chain of custody for the recovered shell casing and Mauser 98 rifle are things that the [Charlie Kirk Investigation Laws](/Fix/overview) may result in powerful truths coming out that aren't out yet.
