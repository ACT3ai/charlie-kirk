...
The decision to transport by personal vehicle rather than waiting for EMS is itself a departure from best practices (see [Hospital Scene & EMS Response](./hospital-scene-ems)), though in a chaotic active-shooter scenario, the instinct to move the victim immediately is understandable.
