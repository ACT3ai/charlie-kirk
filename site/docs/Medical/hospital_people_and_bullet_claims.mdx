...
According to citizen investigation notes summarizing public commentary, **[TPUSA](/TPUSA/overview)-affiliated figures relayed** that the surgeon who treated Charlie after the shooting described the wound as an **"absolute miracle"** — the framing being that the bullet **did not exit**, and that a lodged round potentially **"saved bystanders."**
...
## Citizen Investigator Claims on X (No-Exit / Miracle Quote)
