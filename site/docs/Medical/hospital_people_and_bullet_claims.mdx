...
A related version of the relay attributes to **Andrew Kolvet** (TPUSA) the claim that the surgeon described Charlie as having **"bones of steel"** (sometimes rendered "Man of Steel" or "dense bones") that stopped a **.30-06** round in the neck. **@TheSCIF** (December 2025) questioned why Kolvet would relay or, in that account's framing, allegedly "make up or exaggerate" such quotes to "solidify a narrative." This site does **not** assert that anyone fabricated anything; it notes only that the "bones of steel" quote, like the "absolute miracle" quote, reaches the public **second-hand** and cannot be traced to a named, on-the-record physician. Kolvet is **not accused of any wrongdoing** here.
