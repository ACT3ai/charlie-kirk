...
- **@MarioNawfal** (Sept 2025) treats no-exit as **forensically normal** for certain wound paths and criticizes conspiracy amplification.
- **@HarkjJytte** (July 2026) argues recovered **fragments** can still be used to prop a lone-gunman frame even if they **do not match** the Mauser — a claim about narrative incentives, not a lab result this site has independently verified.
- July 2026 hearing commentary (e.g. **@stratagemmer**, **@alexboge**) states autopsy COD is **GSW neck** with fragments recovered — which bullet-claim debaters must reconcile with no-exit rhetoric and ATF **inconclusive** rifle match filings.
