...
**Dr. [Chris Martenson](/People/chris-martenson)** (@peakprosperity) is cited as confirming a "high-speed cavitation event" based on video analysis.
...
**Official-adjacent frame:** high-velocity **.30-06** neck wound; possible bone hit explaining **no exit** (**@grok** forensic explainer, **July 10, 2026**). **Defense/alt frame:** ATF **cannot identify or exclude** fragments from the recovered rifle; online analysts claim fragment dimensions and fragmentation patterns fit poorly with common non-frangible .30-06 (**@Ariana_J_21**). **Competing mechanism claims** (exploding mic / shaped charge / pressure-wave) remain **unproven hypotheses** discussed by citizen forensics accounts. Witness wording conflicts (chest vs neck) feed both sides — see [Witness Account Conflicts](/Medical/Witness_Account_Conflicts).
