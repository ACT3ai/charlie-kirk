...
published, one per line, with a comment saying why. The run reads it before
generating anything. An excluded video gets no page and no poster, and any page
or poster that already exists for it is DELETED.
